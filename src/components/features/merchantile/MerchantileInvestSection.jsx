...
const local_data = {
  title: "Invest in the E V Revolution <br/> with GO EC Mercantile.",
  description:
  ...
  return (
    <section className="w-full h-auto block py-[30px_15px] sm:py-[60px_30px] xl:py-[120px_60px] 2xl:py-[140px_80px]">
      <div className="container">
        <div className="flex flex-wrap items-center sm:gap-[15px] xl:gap-[60px] 2xl:gap-[80px] mb-[20px] sm:mb-[40px] xl:mb-[60px] 2xl:mb-[80px]">
          ...
          <div className="flex mx-[-5px] sm:mx-[-8px] lg:mx-[-10px] 2xl:mx-[-15px]">
            {data?.list?.map((item, index) => {
              ...
              return (
                <div
                  key={"value" + index}
                  className="flex-[0_0_60%] sm:flex-[0_0_40%] md:flex-[0_0_35%] xl:flex-[0_0_35%] 3xl:flex-[0_0_40%] px-[5px] sm:px-[8px] lg:px-[10px] 2xl:px-[15px]"
                >
                  <div className="w-full h-auto block rounded-[20px] sm:rounded-[30px] bg-[#fcfcfc] border border-[#f0f0f0]">
                    ...
                    <div className="flex flex-col justify-between p-[10px] sm:p-[20px] xl:p-[25px] 2xl:p-[40px]">
                      <div>
                        <Heading
                          as="div"
                          size="heading3"
                        ...
                        <div>
                          <ActionButton
                            ...
                            className={cn(
                              ...
                              " ",
                              isHover
                                ? "text-white max-w-[120px] sm:max-w-[150px] xl:max-w-[160px] 2xl:max-w-[240px] 3xl:max-w-[260px] px-0"
                                : "text-black max-w-[90px] sm:max-w-[90px] xl:max-w-[150px] 2xl:max-w-[125px] 3xl:max-w-[150px] bg-none"
                            )}
                            asChild
                          >
                            <Link href={item?.link}>

  ...
  items: [
    {
      ...
      title: "ECM 25kW",
      features: [
        "Module Capacity Range: 25kW",
        "Super Fast DC Charger Connector : CCS 2",
      ],
      button: {
        link: null,
        label: "Book Now",
    ...
    },
    {
      ...
      features: [
        "7.4kW upto 60kW (Upgradable to 120kW)",
        "Super Fast DC & AC Chargers",
          ...
          {data?.list?.map((item, index) => {
            ...
            return (
              <div
                ...
                className={cn(
                  "",
                  index === lastItem ? "w-full" : "w-full 2xs:w-1/2 sm:w-1/2"
                )}
              >
                  ...
                  <div className="flex-1 flex flex-col justify-between p-[10px] sm:p-[15px] xl:p-[30px] 2xl:p-[40px]">
                    <div>
                      <Heading
                        as="div"
                        size="heading3"
                        className="max-sm:text-[12px] text-[#030303] mb-[2px] sm:mb-[5px] xl:mb-[15px]"
                      >
                        {parse(item?.title)}
                      </Heading>

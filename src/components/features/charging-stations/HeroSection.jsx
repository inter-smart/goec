        ...
        <div className="flex flex-wrap max-sm:flex-col-reverse max-sm:items-center relative z-0">
          <div className="w-full">
            <Heading
              as="h1"
              size="heading1"
              className="line-clamp-3 text-center text-transparent bg-linear-to-r from-[#999] via-50% via-white to-white bg-clip-text max-w-[320px] sm:max-w-[468px] xl:max-w-[576px] 2xl:max-w-[668px] 3xl:max-w-[820px] mx-auto"
            >
              {parse(data?.title)}
            </Heading>
          </div>

    ...
    <section className="w-full h-auto block py-[0_30px] sm:py-[0_60px] xl:py-[0_120px] 2xl:py-[0_140px]">
      <div className="w-full sm:w-[95%] sm:max-w-[860px] lg:max-w-[1080px] xl:max-w-[1220px] 2xl:max-w-[1380] 3xl:max-w-[1820px] mx-auto px-2 mt-[20px] sm:mt-[40px] xl:mt-[120px] 2xl:mt-[140px]">
        <div className="w-full h-auto overflow-hidden rounded-[20px] xl:rounded-[30px] p-[20px] sm:p-[40px] xl:p-[60px] 2xl:p-[80px] 3xl:p-[100px] relative z-0">
          <Image src={"/images/blogdetail-bg.jpg"} alt={"blogdetail"} fill sizes={"1820px"} className="-z-1" />
          <div className="flex flex-wrap justify-between items-center gap-[20px] max-sm:flex-col">
            <div className="flex-1">
              <Heading as="h2" size="heading2" className="leading-tight text-white max-sm:text-center mb-[10px] xl:mb-[15px] 2xl:mb-[20px]">
            ...
            <ActionButton
              ...
              asChild
            >
              <Link href={footer_section?.button?.link ? footer_section?.button?.link : page === "career" ? "/career" : "/about#about-more"}>
                {footer_section?.button?.text || footer_section?.button?.label || "Get in touch"}
              </Link>
            </ActionButton>
          </div>
        </div>

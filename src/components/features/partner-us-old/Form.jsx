...
const formSchema = z.object({
  ...
  type: z.string().min(1, "Please select a type type"),
...
export default function PartnerForm() {
  ...
  return (
    <div className="xl:p-[64px] bg-white rounded-[24px] shadow-[1px_1px_9px_0px_rgba(0,0,0,0.5)]">
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label className="block text-black text-sm mb-2">State</label>
            <Controller
              name="state"
              control={control}
              render={({ field }) => (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            <label className="block text-black text-sm mb-2">Business / Individual</label>
            <Controller
              name="type"
              control={control}
              render={({ field }) => (
        ...
        <div>
          <label className="block text-black text-sm mb-2">Additional information</label>
          <Controller
            name="additionalInfo"
            control={control}
            render={({ field }) => (

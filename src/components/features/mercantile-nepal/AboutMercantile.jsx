...
const aboutData = {
  ...
  vision: "<p>Our vision is to operate a chain of EV Charging Stations across India and positioning GOEC as an authentic player in the EV industry by offering the best service to the end-user with guaranteed quality.</p>",
...
export default function AboutMercantile() {
  return (
    <section className="w-full h-auto block py-[20px] sm:py-[60px] xl:py-[100px] 2xl:py-[140px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 md:gap-[40px] xl:gap-[50px] 2xl:gap-[56px] 3xl:gap-[75px] items-center">
            <div className="h-full flex flex-col">
              <Heading
                as={"h2"}
                size={"heading2"}
                className="text-[#303030] mb-[20px] sm:mb-[40px] xl:mb-[60px] 2xl:mb-[0=90px] 3xl:mb-[120px]"
              >
                {aboutData.title}
              </Heading>
            ...
            <div className="flex justify-center">
              <div className="relative w-full aspect-[588/471] rounded-[24px] overflow-hidden shadow-md">
                <Image
                  src={aboutData.about_media_path}
                  alt={aboutData.about_media_alt}
                  fill
      ...
      <Text
        as="div"
        size={"text2"}
        className="text-[#373737] mt-[20px] lg: 2xl:mt-[60px] 3xl:mt-[80px]"
      >
        {parse(aboutData?.mission)}
      </Text>
    </div>
          {/* --- Box 2 --- */}
           <div className="bg-[#FCFCFC] p-[20px] 2xl:p-[40px] rounded-[24px] border-1 border-[#F0F0F0E5] transition-shadow">

...
export default function LegalInfoSection({ data }) {
    ...
    <section className="w-full h-auto block py-[40px] sm:py-[60px] xl:py-[120px] 2xl:py-[140px]">
      <div className="container">
        <div className="flex flex-wrap sm:mx-[-20px] xl:mx-[-30px] 2xl:mx-[-40px] sm:[&>*]:px-[20px] xl:[&>*]:px-[30px] 2xl:[&>*]:px-[40px]">
          <div className="w-full h-full sm:w-[320px] xl:w-[368px] 2xl:w-[440px] sm:sticky top-[var(--header-y)] self-start">
            <nav className="w-full h-auto mb-[15px]">
              {toc.length > 0 ? (
                <ul className="block">
                  {toc.map((item) => (
                    <li
                    ...
                    >
                      <a
                        ...
                        className={cn(
                          "text-[12px] sm:text-[14px] xl:text-[16px] 2xl:text-[18px] leading-tight  truncate w-full h-auto flex items-center gap-[4px] xl:gap-[8px] transition-all duration-300",
                          activeId === item.id
                      ...
                      >
                        <svg
                          ...
                          className={cn("size-[6px] xl:size-[8px] block transition ease-in",
                        ...
                        >
                          ...
                          <path
                            d="M5.73207 2.59636C6.33621 2.93619 6.33621 3.806 5.73207 4.14583L1.32294 6.62596C0.730403 6.95927 -0.00173616 6.53107 -0.00173616 5.85123V0.890958C-0.00173616 0.211112 0.730404 -0.217078 1.32294 0.116224L5.73207 2.59636Z"
                            fill="url(#paint0_linear_3058_25422)"
                          />
                          <defs>
                            <linearGradient
                              id="paint0_linear_3058_25422"
                              x1="3.55382"
                              y1="-0.628906"
                              x2="3.55382"
                              y2="7.37109"
                            ...
                            >
                              <stop stop-color="#0F51A9" />
                              <stop offset="0.602236" stop-color="#0055E0" />
          ...
          <div className="w-full sm:w-[calc(100%-320px)] xl:w-[calc(100%-368px)] 2xl:w-[calc(100%-440px)]">
            <div
              ref={contentRef}
              className="typography [&,_&>p]:text-[#757575] [&_h1]:text-[#030303] [&_h2]:text-[#030303] [&_h3]:text-[#030303] [&_h4]:text-[#030303] [&_h5]:text-[#030303] [&_h6]:text-[#030303] [&_h1]:font-bold [&_h2]:font-bold [&_h3]:font-semibold [&_h4]:font-semibold [&_h1]:mb-4 [&_h2]:mb-3 [&_h3]:mb-2 [&_h4]:mb-2 [&_h1]:mt-8 [&_h2]:mt-6 [&_h3]:mt-4 [&_h4]:mt-3 [&_p]:mb-4 [&_ul]:mb-4 [&_ol]:mb-4"
            >
              {parse(description)}
            </div>
          </div>

      ...
      <div className="min-h-screen mt-[150px] mx-[30px] md:mx-[135px] lg:mx-[178px] xl:mx-[250px] 2xl:mx-[267px] 3xl:mx-[335px] mb-[73px] lg:mb-[95px] xl:mb-[140px] 2xl:mb-[146px] 3xl:mb-[197px]">
        <div className="container mx-auto">
          ...
          <div className="flex flex-col xs:flex-row justify-between items-start sm:items-center gap-4 my-[30px_18px] lg:my-[30_24px] xl:my-[56px_33px] 2xl:my-[60px_36px] 3xl:my-[75px_44px]">
            ...
            <div className="flex gap-3">
              ...
              <ActionButton
                ...
                className="rounded-full p-[10px_20px] cursor-pointer hover:bg-gradient-to-r hover:from-[#2CC59C] hover:via-[#00EEA8] hover:to-[#2CC59C] transition duration-300 ease-in-out"
              >
                Apply Now
              </ActionButton>
            </div>
          ...
          <ActionButton
            ...
            variant={"blue"}
            onClick={() => setOpenModal(true)}
            className="cursor-pointer flex items-center justify-center w-[100%] mt-[40px] lg:mt-[50px] xl:mt-[80px] 2xl:mt-[90px] 3xl:mt-[120px] py-[10px] rounded-full font-medium hover:bg-gradient-to-r hover:from-[#2CC59C] hover:via-[#00EEA8] hover:to-[#2CC59C] transition duration-300 ease-in-out"
          >
            Apply Now
            <HiArrowLongRight />
          </ActionButton>

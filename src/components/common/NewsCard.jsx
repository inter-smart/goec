  ...
  return (
    <Suspense fallback={<NewsCardSkeleton />}>
      <div className="w-full h-auto block rounded-[20px] sm:rounded-[30px] bg-[#fcfcfc] border border-[#f0f0f0]">
        <div
          className={cn(
            "w-full h-auto aspect-[4/2] overflow-hidden relative z-0",
        ...
        <div className="flex flex-col justify-between p-[15px_15px] sm:p-[15px_20px] xl:p-[20px_30px] 2xl:p-[30px_40px]">
          <div>
            ...
            {variant === "blog-detail" && (
              <div className="text-[10px] sm:text-[12px] xl:text-[14px] 2xl:text-[16px] 3xl:text-[20px] leading-tight line-clamp-1 font-normal text-[#757575] mb-[10px] xl:mb-[15px] 2xl:mb-[20px]">

...
export default function HeroWithCard({ children }) {
  return (
    <>
      <section className="w-full h-auto min-h-[468px] xl:min-h-[540px] 2xl:min-h-[620px] 3xl:min-h-[768px] flex items-start bg-black py-[calc(40px+var(--header-y))_40px] sm:py-[calc(60px+var(--header-y))_60px] xl:py-[calc(100px+var(--header-y))_100px] 2xl:py-[calc(120px+var(--header-y))_120px] relative z-0">
      ...
      <div className="container bg-white z-10 relative -mt-[150px] rounded-[24px] shadow-xl xl:p-[28px] p-6 mb-[80px]">
        <div className="mb-8">

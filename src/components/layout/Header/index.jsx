              ...
              <div>
                <Sheet>
                  <SheetTrigger className="select-none">
                    <div className="lg:hidden text-[14px] sm:text-[12px] xl:text-[14px] 2xl:text-[16px] leading-none font-normal text-center text-white w-full flex items-center justify-center ">
                      <Image
            ...
            {data?.sub_item?.map((item, index) => {
              ...
              return (
                <div
                  ...
                  className="lg:my-1 2xl:my-1.5 max-lg:mb-[10px]"
                >
                  {hasSubItems ? (
                    <button

...
const inputStyle = `
  text-[14px] sm:text-[12px] xl:text-[14px] 2xl:text-[16px] 3xl:text-[18px] leading-none font-normal text-[#373737] placeholder:text-[#a9a9a9] w-full !h-[35px] xl:!h-[40px] 2xl:!h-[45px] bg-white border-[#a2a2a2] px-[15px] 2xl:px-[20px] focus:outline-none focus:ring-0 focus-visible:ring-1 focus-visible:border-transparent
...
export default function BecomePartnerForm() {
  ...
  async function onSubmit(values) {
    ...
    try {
      const recaptchaToken = await executeRecaptcha("partnerenquiry");
      ...
      <form onSubmit={form.handleSubmit(onSubmit)}>
        <div className="flex flex-wrap -mx-1 xl:-mx-2 [&>*]:p-1 xl:[&>*]:p-2">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="w-full sm:w-1/2">
                ...
                <FormControl>
                  <Input type="text" placeholder="Enter pincode" className={inputStyle} {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="w-full sm:w-1/2">
                <FormLabel className={labelStyle}>Business / Individual</FormLabel>
